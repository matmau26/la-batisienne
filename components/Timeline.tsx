...
const steps: Step[] = [
  {
    ...
    desc: "L'arène s'ouvre, les vans débarquent, les tentes se dressent. Présentations sur fond de basses.",
    accent: "blue",
  },
  {
    when: "Samedi — Soir",
  ...
  },
  {
    ...
    desc: "Piscine, sono, bombes à eau et lunettes noires. Clôture en apothéose. Notre lundi est posé !",
    accent: "red",
  },
];
